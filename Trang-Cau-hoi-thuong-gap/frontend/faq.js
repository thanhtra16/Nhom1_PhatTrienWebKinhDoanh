document.addEventListener("DOMContentLoaded", () => {
    ...
    // 1. ĐÓNG MỞ MENU THẢ XUỐNG (Giống hoàn toàn trang-chu.html)
    ...
    // 2. FETCH VÀ RENDER DỮ LIỆU SẢN PHẨM TRÊN MEGA MENU TỪ MONGODB
    ...
    // 3. FETCH DỮ LIỆU CÂU HỎI & LOGIC TÌM KIẾM FAQ
    ...
    if (btnToggleAll) {
        // Biến trạng thái: false nghĩa là hiện tại đang thu gọn
        let isAllExpanded = false; 

        btnToggleAll.addEventListener('click', () => {
            const allCards = document.querySelectorAll('.the-cau-hoi');
            isAllExpanded = !isAllExpanded; // Đảo trạng thái khi bấm
            ...
            allCards.forEach(card => {
                ...
                if (isAllExpanded) {
                    // Nếu trạng thái là Mở tất cả: ép mở các thẻ đang đóng
                    ...
                    // Nếu trạng thái là Thu gọn tất cả: ép đóng các thẻ đang mở
                    if (answer.classList.contains('mo')) {
            ...
            // Cập nhật lại Giao diện (Chữ và Icon) của nút bấm chính
            if (isAllExpanded) {
